...
public class AdvancedPanelSearch extends JPanel {
    ...
    private JDateChooser dateChooserOne;
    private JDateChooser dateChooserTwo;
    ...
    public void settings() {
        ...
        chFechas.setBounds(8, 12, 100, 23);
        this.add(chFechas);

        dateChooserOne.getDate();
        dateChooserOne.setEnabled(false);
        dateChooserOne.setBounds(120, 13, 120, 20);
        this.add(dateChooserOne);

        dateChooserTwo.getDate();
        dateChooserTwo.setEnabled(false);
        dateChooserTwo.setBounds(120, 39, 120, 20);
        this.add(dateChooserTwo);
        ...
        chAttributes.setBounds(380, 12, 150, 23);
    ...
    public void initComponents() {
        ...
        dateChooserOne = new JDateChooser(null, null, null,
                new JSpinnerDateEditor());
        dateChooserTwo = new JDateChooser(null, null, null,
                new JSpinnerDateEditor());
    ...
    private void chFechasStateChanged(ChangeEvent evt) {
        if (this.isFechasEnabled != chFechas.isSelected()) {
            ...
            dateChooserOne.setEnabled(isFechasEnabled);
            dateChooserTwo.setEnabled(isFechasEnabled);
        }
    }
